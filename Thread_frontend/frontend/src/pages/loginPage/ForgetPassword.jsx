  ...
  function ConfirmPassword() {
    if (
      ...
      document
        ...
        .classList.add("focus:border-red-600");
      document
        .getElementById("confirm_password")
        .classList.remove("focus:border-green-600");
    } else {
      document
        .getElementById("confirm_password")
        .classList.add("focus:border-green-600");
      document
        .getElementById("confirm_password")
                  ...
                  {length > 0 && (
                    <div className="flex items-center gap-3 m-1">
                      <div
                        ...
                        id="passwordStrengthValue"
                      ></div>
                      <div
                        className="h-2 w-20 rounded-lg"
                        id="passwordStrengthColor"
                      ></div>
                    </div>
                  )}
                </div>
