        ...
        <div class="flex flex-col h-full">
          <div className="h-20 flex pl-6 items-center pt-6">
            <div className="flex justify-center items-center">
              <img src="/MyImages/logo-final.png" width={170} height={160} className="mx-auto" />
